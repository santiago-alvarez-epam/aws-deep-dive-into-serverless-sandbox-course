# Task02 - AWS Lambda with Function URL Deployment

## Generate project files

```bash
syndicate generate project --name "task02" --path .
```
...
```bash
2024-05-09 22:19:59,946 [WARNING] USER:santiago_alvarez generator.py:93:generate_configuration_files LOG: The "project_path" property is not specified. The working directory will be used as a project path. To change the path, edit the syndicate.yml by path /Users/santiago_alvarez/Learning/aws-deep-dive-into-serverless-sandbox-course/task02/.syndicate-config-dev
2024-05-09 22:19:59,954 [INFO] USER:santiago_alvarez generator.py:155:generate_configuration_files LOG: Syndicate initialization has been completed. 
Set SDCT_CONF:
Unix: export SDCT_CONF="/Users/santiago_alvarez/Learning/aws-deep-dive-into-serverless-sandbox-course/task02/.syndicate-config-dev"
Windows: setx SDCT_CONF /Users/santiago_alvarez/Learning/aws-deep-dive-into-serverless-sandbox-course/task02/.syndicate-config-dev
```

Execute:

```bash
export SDCT_CONF="/Users/santiago_alvarez/Learning/aws-deep-dive-into-serverless-sandbox-course/task02/.syndicate-config-dev"
```
...
```bash
Configuration used: /Users/santiago_alvarez/Learning/aws-deep-dive-into-serverless-sandbox-course/task02/.syndicate-config-dev
Lambda names: ('hello_world',)
Runtime: python
Project path: .
2024-05-09 22:20:48,407 [INFO] USER:santiago_alvarez lambda_function.py:146:generate_lambda_function LOG: Lambda hello_world has been successfully added to the project.
```
